...
const t_types	g_types[] =  {
	...
	{"int[2]", &printPointer},
	{"uint32_t", &printUint},
	{"unsigned int", &printUint},
	{"long", &printLong},
	{"unsigned long", &printUlong},
	{"u64", &printUlong},
	{"size_t", &printUlong},
	{"ssize_t", &printLong},
	{"caddr_t", &printString},
	...
	{"key_t", &printUlong},
	{"pid_t", &printInt},
	{"socklen_t", &printUlong},
	{"uid_t", &printInt},
	{"gid_t", &printInt},
	{"gid_t[]", &printPointer},
	{"clock_t", &printUlong},
	{"cap_user_header_t", &printPointer},
	{"cap_huser_data_t", &printPointer},
	{"dev_t", &printUlong},
	{"off64_t", &printUlong},
	{"cpu_set_t", &printUlong},
	{"aio_context_t", &printUlong},
	{"mqd_t", &printInt},
	{"idtype_t", &printUlong},
...
const t_prototype	g_syscalls[] =
{
	...
	{"brk", 1, {"int"}, "void *"},
	{"sigaction", 3, {"int", "struct sigaction *", "struct sigaction *"}, "int"},
	...
	{"pipe", 1, {"int[2]"}, "int"},
	{"select", 5, {"int", "fd_set *", "fd_set *", "fd_set *", "stuct timeval *"}, "int"},
	...
	{"setitimer", 3, {"int", "struct itimerval *", "struct itimerval *"}, "int"},
	...
	{"sendto", 6, {"int", "void *", "size_t", "int", "struct sockaddr *", "socklen_t"}, "ssize_t"},
	{"recvfrom", 6, {"int", "void *", "size_t", "int", "struct sockaddr *", "socklen_t *"}, "ssize_t"},
	...
	{"setsockopt", 5, {"int", "int", "int", "void *", "socklen_t"}, "int"},
	...
	{"getdents", 3, {"unsigned int", "struct linux_dirent *", "unsigned int"}, "int"},
	...
	{ "ptrace", 4, {"int", "pid_t", "void *", "void *"}, "long"}, {"getuid", 0, {"void"}, "uid_t"},
	...
	{"sigtimedwait", 3, {"sigset_t *", "siginfo_t *", "struct timespec *"}, "int"},
	...
	{"sched_setscheduler", 3, {"pid_t", "int", "struct sched_param *"}, "int"},
	...
	{"prctl", 5, {"int", "unsigned long", "unsigned long", "unsigned long", "unsigned long"}, "int"},
	...
	{"mount", 5, {"char *", "char *", "char *", "unsigned long", "void *"}, "int"},
	...
	{"query_module", 5, {"char *", "int", "void *", "size_t", "size_t"}, "int"},
	{"quotactl", 4, {"int", "char *", "int", "caddr_t"}, "int"},
	{"nfsservctl", 3, {"int", "struct nfsctl_arg *", "union nfsctl_res *"}, "int"},
	...
	{"setxattr", 5, {"char *", "char *", "void *", "size_t", "int"}, "int"},
	{"lsetxattr", 5, {"char *", "char *", "void *", "size_t", "int"}, "int"},
	{"fsetxattr", 5, {"int", "char *", "void *", "size_t", "int"}, "int"},
	{"getxattr", 4, {"char *", "char *", "void *", "size_t"}, "ssize_t"},
	{"lgetxattr", 4, {"char *", "char *", "void *", "size_t"}, "ssize_t"},
	...
	{"futex", 6, {"int *", "int", "int", "struct timespec *", "int *", "int"}, "int"},
	...
	{"io_getevents", 5, {"aio_context_t", "long", "long", "struct io_event *", "struct timespec *"}, "int"},
	{"io_submit", 3, {"aio_context_t", "long", "struct iocb **"}, "int"},
	{"io_cancel", 3, {"aio_context_t", "struct iocb *", "struct io_event *"}, "int"},
	...
	{"remap_file_pages", 5, {"void *", "size_t", "int", "ssize_t", "int"}, "int"},
	{"getdents64", 3, {"unsigned int", "struct linux_dirent *", "unsigned int"}, "int"},
	{"set_tid_address", 1, {"int *"}, "long"},
	{"restart_syscall", 2, {"int", "int"}, "int"},
	{"semtimedop", 4, {"int", "struct sembuf *", "unsigned int", "struct timespec *"}, "int"},
	{"fadvise64", 4, {"int", "off_t", "off_t", "int"}, "int"},
	{"timer_create", 3, {"clockid_t", "struct sigevent *", "time_t *"}, "int"},
	{"timer_settime", 4, {"timer_t", "int", "struct itimerspec *", "struct itimerspec *"}, "int"},
	...
	{"clock_nanosleep", 4, {"clockid_t", "int", "struct timespec *", "struct timespec *"}, "int"},
	...
	{"mbind", 6, {"void *", "unsigned long", "int", "unsigned long *", "unsigned long", "unsigned int"}, "int"},
  	{"set_mempolicy", 3, {"int", "unsigned long *", "unsigned long"}, "int"},
  	{"get_mempolicy", 5, {"int *", "unsigned long *", "unsigned long", "unsigned long", "unsigned long"}, "int"},
	{"mq_open", 2, {"int", "int"}, "int"},
	{"mq_unlink", 1, {"char *"}, "int"},
	{"mq_timedsend", 5, {"mqd_t", "char *", "size_t", "unsigned int", "struct timespec *"}, "int"},
	{"mq_timedreceive", 5, {"mqd_t", "char *", "size_t", "unsigned int", "struct timespec *"}, "int"},
	{"mq_notify", 2, {"mqd_t", "struct sigevent *"}, "int"},
	{"mq_getsetattr", 3, {"mqd_t", "struct mq_attr *", "struct mq_attr *"}, "int"},
	{"kexec_load", 4, {"unsigned long", "unsigned long", "struct kexec_segment *", "unsigned long"}, "int"},
	{"waitid", 4, {"idtype_t", "id_t", "siginfo_t", "int"}, "int"},
	{"add_key", 5, {"char *", "char *", "void *", "size_t", "key_serial_t"}, "key_serial_t"},
	{"request_key", 4, {"char *", "char *", "char *", "key_serial_t"}, "key_serial_t"},
	{"keyctl", 1, {"int"}, "int"},
	...
	{"migrate_pages", 4, {"int", "unsigned long", "unsigned long *", "unsigned long *"}, "long"},
	...
	{"pselect6", 6, {"int", "fd_set *", "fd_set *", "fd_set *", "struct timespec *", "sigset_t"}, "int"},
	{"ppoll", 4, {"struct pollfd *", "nfds_t", "struct timespec *", "sigset_t *"}, "int"},
	{"unshare", 1, {"int"}, "int"},
	{"set_robust_list", 2, {"struct robust_list_head *", "size_t"}, "long"},
	{"get_robust_list", 5, {"int", "char *", "int", "char *", "int"}, "int"},
	{"splice", 6 , {"int", "loff_t *", "int", "loff_t *", "size_t", "unsigned int"}, "ssize_t"},
	{"tee", 4, {"int", "int", "size_t", "unsigned int"}, "ssize_t"},
	{"sync_file_range", 4, {"int", "off64_t", "off64_t", "unsigned int"}, "int"},
	{"vmsplice", 4, {"int", "struct iovec *", "unsigned long", "unsigned int"}, "ssize_t"},
	{"move_pages", 6, {"int", "unsigned long", "void **", "int *", "int *", "int"}, "long"},
	{"utimensat", 4, {"int", "char *", "struct timespec[]", "int"}, "int"},
	{"epoll_pwait", 4, {"int", "struct epoll_event *", "int", "int", "sigset_t"}, "int"},
	...
	{"timerfd_settime", 4, 	{"int", "int", "struct itimerspec *", "struct itimerspec *"}, "int"},
	...
	{"eventfd2", 4, {"int", "char *", "struct timespec *", "int"}, "int"},
	{"epoll_create1", 1, {"int"}, "int"},
	{"dup2", 2, {"int", "int"}, "int"},
	{"pipe2", 2, {"int[2]", "int"}, "int"},
	{"inotify_init1", 1, {"int"}, "int"},
	{"preadv", 4, {"int", "struct iovec *", "int", "off_t"}, "ssize_t"},
	{"pwritev", 3, {"int", "struct iovec *", "int"}, "ssize_t"},
	{"sys_rt_tgsigqueueinfo", 3, {"int", "int", "siginfo_t *"}, "long"},
	{"perf_event_open", 4, {"int", "struct sockaddr *", "socklen_t", "int"}, "int"},
	{"recvmmsg", 5, {"int", "struct mmsghdr *", "unsigned int", "unsigned int", "struct timespec *"}, "int"},
	{"fanotify_init", 4, {"int", "struct sockaddr *", "socklen_t", "int"}, "int"},
	{"fanotify_init", 4, {"int", "struct sockaddr *", "socklen_t", "int"}, "int"},
	{"prlimit", 4, {"pid_t", "int", "struct rlimit *", "struct rlimit *"}, "int"},
	{"name_to_handle_at", 1, {"int"}, "int"},
	{"open_to_handle_at", 4, {"int", "struct iovec *", "int", "off_t"}, "ssize_t"},
	{"clock_adjtime", 3, {"int", "struct iovec *", "int"}, "ssize_t"},
	{"syncfs", 1, {"int"}, "int"},
	{"sendmmsg", 4, {"int", "struct mmsghdr *", "unsigned int", "unsigned int"}, "int"},
	{"setns", 2, {"int", "int"}, "int"},
	{"getcpu", 3, {"unsigned *", "unsigned *", "struct getcpu_cache *"}, "int"},
	{"process_vm_readv", 6, {"pid_t", "struct iovec *", "unsigned long", "struct iovec *", "unsigned long", "unsigned long"}, "ssize_t"},
	{"process_vm_writev", 6, {"pid_t", "struct iovec *", "unsigned long", "struct iovec *", "unsigned long", "unsigned long"}, "ssize_t"},
	{"kcmp", 5, {"pid_t", "pid_t", "int", "unsigned long", "unsigned long"}, "int"},
